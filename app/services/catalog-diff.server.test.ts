...
describe("diff safety limits", () => {
  it.each([
    ["depth", {maxDepth: 0, maxVisitedNodes: 20, maxEntries: 20}],
    ["nodes", {maxDepth: 20, maxVisitedNodes: 1, maxEntries: 20}],
    ["entries", {maxDepth: 20, maxVisitedNodes: 20, maxEntries: 1}],
